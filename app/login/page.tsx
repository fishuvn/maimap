        ...
        <div className="glass-strong rounded-2xl p-6">
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input id="login-username" type="text" value={username} onChange={(e) => setUsername(e.target.value)} placeholder="yourname" required autoFocus
          ...
          <p className="text-center text-xs text-zinc-500 mt-4">{"Don't have an account? "}<Link href="/register" className="text-violet-400 hover:text-violet-300 font-medium">Register</Link></p>
        </div>
      </div>
    </div>
  );
